...
TOKEN = '6714181727:AAHskOUUt7Yfq2UvKwp6H4nK9mFYpXe4vd4'
...
FORWARD_CHANNEL_ID = -1002181562902
CHANNEL_ID = -1002181562902
error_channel_id = -1002181562902
...
def handle_message(message):
    if message.text == "":
        ...
        bot.send_message(message.chat.id, "*Dm - @Foxengine_yt*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Owner - @Foxengine_yt*", parse_mode='Markdown')
    else:
